    ...
    <div class="col-lg-12">
        <div class="form-panel">
            <h4 class="mb">
                ...
                </i> EDIT USERS INFORMTION</h4>

            <form enctype="multipart/form-data" class="form-horizontal style-form" action="{{ route('dashboard.users.update' , $user->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text"  name="last_name" required class="form-control round-form" value="{{  $user->last_name }}">
                ...
                <!-- /panel-body -->
                <br>
                <button type="submit" style="margin-left: 50%" class="btn btn-round btn-primary right"><i class="fa fa-plus"></i>UPDATE</button>
